...
class CalendarEvent extends Page
{
	...
	private function getExceptionsTable()
	{
		$table = new TableField(
			...
			array('ExceptionDate' => 'CalendarDateField'), 
			null, 
	...
	public function CurrentDate()
	{
		if(!$date = CalendarUtil::getDateFromURL())
			$date =  DataObject::get_one($this->getDateTimeClass(),"EventID = {$this->ID}", "StartDate ASC");
		if($date) {
			if($this->Recursion) {
