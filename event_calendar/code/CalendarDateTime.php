...
class CalendarDateTime extends DataObject
{
	...
	public function getAnnouncementPopup()
	{
		...
		$f->push(new CalendarTimeField('StartTime',_t('CalendarDateTime.STARTTIME','Start Time')));
		$f->push(new CalendarDateField('EndDate',_t('CalendarDateTime.ENDDATE','EndDate')));
		$f->push(new CalendarTimeField('EndTime',_t('CalendarDateTime.ENDTIME','End Time')));
	...
	{
		$f = new FieldSet();
		if(isset($this->table_fields['StartDate'])) $f->push(new CalendarDateField('StartDate',_t('CalendarDateTime.STARTDATE','Start Date')));
		if(isset($this->table_fields['StartTime'])) $f->push(new CalendarTimeField('StartTime',_t('CalendarDateTime.STARTTIME','Start Time')));
		if(isset($this->table_fields['EndDate'])) $f->push(new CalendarDateField('EndDate',_t('CalendarDateTime.ENDDATE','EndDate')));
		if(isset($this->table_fields['EndTime'])) $f->push(new CalendarTimeField('EndTime',_t('CalendarDateTime.ENDTIME','End Time')));
	...
	protected $table_fields = array(
		...
		'StartTime' => 'CalendarTimeField',
		'EndTime' => 'CalendarTimeField',
	...
	private function initPopupFields() 
	{
		$this->popup_table_fields = array(
			...
			new CalendarDateField('EndDate', _t('CalendarEvent.ENDDATE','End Date')),
			new CalendarTimeField('StartTime',_t('CalendarEvent.STARTTIME','Start Time')),
			new CalendarTimeField('EndTime', _t('CalendarEvent.ENDTIME','End Time (blank if none)')),
	...
	private function initAnnouncementFields() 
	{
		$this->announcement_table_fields = array(
			...
			new CalendarDateField('StartDate',_t('CalendarEvent.STARTDATE','Start Date')),
			new CalendarTimeField('StartTime',_t('CalendarEvent.STARTTIME','Start Time')),
			new CalendarDateField('EndDate',_t('CalendarEvent.ENDDATE','EndDate')),
			new CalendarTimeField('EndTime',_t('CalendarEvent.ENDTIME','End Time')),
			new CheckboxField('is_all_day',_t('CalendarEvent.ALLDAY','All Day')),
